...
public class ViewHolder {
    ...
    public ViewHolder setImageByUrl(int viewId, String url) {
        ...
        Glide.with(mContext).load(url).asBitmap().into(new BitmapImageViewTarget(iv));
        return this;
    }
    ...
    public ViewHolder setImageByUrl(int viewId, int defaultResId, String url) {
        ...
        Glide.with(mContext).load(url).asBitmap()
                .placeholder(defaultResId).error(defaultResId).dontAnimate().diskCacheStrategy(DiskCacheStrategy.RESULT).into(new BitmapImageViewTarget(iv));
        return this;
    }
     ...
     *@param url  @return
     */
    public ViewHolder setRoundedImageByUrl(int viewId, int defaultResId, int radius, String url) {
        final ImageView iv = getView(viewId);
        Glide.with(mContext).load(url).dontAnimate().placeholder(defaultResId).error(defaultResId).diskCacheStrategy(DiskCacheStrategy.RESULT)
                .bitmapTransform(new RoundedCornersTransformation(mContext, radius, 0, RoundedCornersTransformation.CornerType.ALL)).into(iv);
        return this;
    }
