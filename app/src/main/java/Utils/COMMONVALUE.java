...
public class COMMONVALUE {
    ...
    public static final int SELECT_ADAPTER_1 = 5;
    public static final int SELECT_ADAPTER_2 = 6;
    public static final int SELECT_ADAPTER_3 = 7;
    public static final int SELECT_ADAPTER_4 = 8;
