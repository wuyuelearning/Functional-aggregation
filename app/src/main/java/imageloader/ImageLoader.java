...
public class ImageLoader {
    ...
    public static final int MESSAFE_POST_RESULT = 1;
    ...
    private void addBitmapToMemoryCache(String key, Bitmap bitmap) {
        if (getBitmapFromMeCache(key) == null) {
            mMemoryCache.put(key, bitmap);
        }
    }

    private Bitmap getBitmapFromMeCache(String key) {
        ...
        Runnable loadBitmapTask = new Runnable() {
            ...
            public void run() {
                ...
                if (bitmap != null) {
                    ...
                    mMainHandler.obtainMessage(MESSAFE_POST_RESULT, result).sendToTarget();
                }
            }
        };
    ...
    private Bitmap loadBitmapFromMemCache(String url) {
        ...
        Bitmap bitmap = getBitmapFromMeCache(key);
        return bitmap;
    }
